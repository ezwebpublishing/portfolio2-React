          ...
          <ul className="grid">
            <li className="">
              ...
              <div className="work-hover-desc">
                ...
                <p>제작 기한 : 약 3주</p>
                <p>피그마, 포토샵, 구글 캘린더 </p>
                <a href="https://www.figma.com/proto/2gckeiReA5euFJkdkTq4Kl/1%EC%B0%A8-%EA%B3%BC%EC%A0%9C-%ED%8E%98%EC%9D%B4%EC%A7%80-%EB%A6%AC%EB%89%B4%EC%96%BC---%EB%A5%B4%EC%84%B8%EB%9D%BC%ED%95%8C?page-id=30%3A117&node-id=30-118&viewport=441%2C424%2C0.02&t=RdYxVRgXAPf7NpXe-1&scaling=min-zoom&content-scaling=fixed" className="tit-h4 shortcut" target="">바로가기 &#187;</a>
              </div>
            </li>
            <li className="">
              ...
              <div className="work-hover-desc">
                ...
                <p>제작 기한 : 약 4주</p>
                <p>피그마, 포토샵, 엑셀, 슬렉</p>
                <a href="https://www.figma.com/proto/yIwo11tJX1epVXVyCZwkfm/%EC%8B%9C%ED%81%AC%EB%A6%BF-%EC%A5%AC%EC%A5%AC-2?page-id=641%3A5456&node-id=670-4919&viewport=814%2C1101%2C0.03&t=0YWGqwIaFGc5jM8H-1&scaling=min-zoom&content-scaling=fixed" className="tit-h4 shortcut" target="_blank">바로가기 &#187;</a>
              </div>
            </li>
            <li className=""> 
            ...
            <li className="">
              ...
              <div className="work-hover-desc">
                ...
                <p>제작 기한 : 약 4주</p>
                <p>피그마, 포토샵, 일러스트</p>
                <a href="https://www.figma.com/proto/7XQQkHH0qMk1BTprlcXamZ/%EC%8B%9C%EC%9E%A5%ED%95%98%EC%8B%9C%EC%A3%A0-%EC%A0%9C%EC%B6%9C%ED%8E%98%EC%9D%B4%EC%A7%80?page-id=0%3A1&node-id=669-1417&viewport=589%2C338%2C0.02&t=WiBWTMVlaBGegie1-1&scaling=scale-down-width&content-scaling=fixed" className="tit-h4 shortcut">바로가기 &#187;</a>
              </div>
            </li>
            <li className="">
              ...
              <div className="work-hover-desc">
                ...
                <p>제작 기한 : 약 4주</p>
                <p>피그마, 포토샵</p>
                <a href="https://www.figma.com/proto/TSC8SxmxGCVYAtVqdF8aSC/%EC%82%BC%EC%84%B1SDI-%EB%A6%AC%EB%89%B4%EC%96%BC?page-id=0%3A1&node-id=414-500&viewport=-287%2C855%2C0.02&t=Q0HSJCA37u52WOjT-1&scaling=min-zoom&content-scaling=fixed" className="tit-h4 shortcut" target="_blank">바로가기 &#187;</a>
              </div>
            </li>
            <li className="">
              ...
              <div className="work-hover-desc">
                ...
                <p>제작 기한 : 약 2주</p>
                <p>피그마, 포토샵, 일러스트</p>
                <a href="https://www.figma.com/proto/CjyRdoOzDLwRgdgfGfX4BU/%EA%B5%AC%EB%91%90%EB%B0%9C%ED%91%9C-%ED%8F%89%EA%B0%80-%EC%A0%9C%EC%B6%9C%ED%8E%98%EC%9D%B4%EC%A7%80?page-id=25%3A111&node-id=25-112&viewport=442%2C333%2C0.09&t=S3OeY78za0Jr26nu-1&scaling=contain&content-scaling=fixed" className="tit-h4 shortcut" target="_blank">바로가기 &#187;</a>
              </div>
            </li>
            <li className="">
              ...
              <div className="work-hover-desc">
                ...
                <p>제작 기한 : 약 5주</p>
                <p>피그마, 포토샵, 일러스트</p>
                <a href="https://www.figma.com/proto/gIeAZXRXDeyb1GKToWaWZk/'%EC%98%A4'%ED%82%A4%EC%B9%9C?page-id=0%3A1&node-id=1-290&viewport=442%2C373%2C0.06&t=B2LgsDQS2Hipz8KF-1&scaling=contain&content-scaling=fixed" className="tit-h4 shortcut" target="_blank">바로가기 &#187;</a>
              </div>
            </li>
            <li className="">
